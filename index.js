...
resButton.addEventListener('click', function(event){
  ...
  if (document.getElementById('mm-form')) {
    var getForm = document.getElementById('mm-form');
    getForm.remove();
    resButtonCont.appendChild(mmButton);
    mmButton.setAttribute('id','mm-button');
  } else {
    resButton.remove();
...
mmButton.addEventListener('click', function(event) {
  ...
  if (document.getElementById('res-form')) {
    ...
    getForm.remove();
    resButtonCont.appendChild(resButton);
    resButton.setAttribute('id','res-button');
  } else {
    mmButton.remove();
    var form = document.createElement('form');
